...
\InSquare\OpendxpProcessManagerBundle\ExecutionTrait::executeChildProcesses($monitoringItem,$data,5,50,function ( MonitoringItem $monitoringItem, \InSquare\OpendxpProcessManagerBundle\Executor\PimcoreCommand $executor){
