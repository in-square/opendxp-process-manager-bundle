...
**URL: http://YOUR-DOMAIN/webservice/insquare-opendxp-process-manager/rest/execute?username=ckogler&apiKey=secret**
...
**URL: http://YOUR-DOMAIN/webservice/insquare-opendxp-process-manager/rest/monitoring-item-state?username=ckogler&apiKey=secret**
