...
```console
"insquare/opendxp-process-manager-bundle": "v3.*"
```

Then execute:

```console
COMPOSER_MEMORY_LIMIT=-1 composer update insquare/opendxp-process-manager-bundle
bin/console pimcore:bundle:update InSquareOpendxpProcessManagerBundle
```
...
```console
"insquare/opendxp-process-manager-bundle": "v4.*"
```
