...
namespace InSquare\OpendxpProcessManagerBundle\Model;
...
use InSquare\OpendxpProcessManagerBundle\Message\CheckCommandAliveMessage;
 ...
 */
class MonitoringItem extends \OpenDxp\Model\AbstractModel
{
    ...
    protected \InSquare\OpendxpProcessManagerBundle\Logger $logger;
    ...
    {
        return InSquareOpendxpProcessManagerBundle::getLogDir() . $this->getId() . '.log';
    }
    ...
    public function getLogger(): \InSquare\OpendxpProcessManagerBundle\Logger
    {
        if (!isset($this->logger)) {
            $this->logger = new \InSquare\OpendxpProcessManagerBundle\Logger();
