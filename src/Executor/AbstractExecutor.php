...
abstract class AbstractExecutor implements \JsonSerializable
{
    ...
    {
        return Console::getPhpCli() . ' ' . realpath(OPENDXP_PROJECT_ROOT . DIRECTORY_SEPARATOR . 'bin' . DIRECTORY_SEPARATOR . 'console') . ' process-manager:execute-shell-cmd --monitoring-item-id=' . $monitoringItem->getId();
    }
