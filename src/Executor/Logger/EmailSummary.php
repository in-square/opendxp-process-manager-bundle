...
class EmailSummary extends AbstractLogger
{
    ...
    public string $extJsClass = 'opendxp.plugin.processmanager.executor.logger.emailSummary';
    ...
    {
        $dir = \InSquare\OpendxpProcessManagerBundle\InSquareOpendxpProcessManagerBundle::getLogDir().'email/' . $monitoringItem->getId() ;
