...
namespace InSquare\OpendxpProcessManagerBundle\Executor\Action;
...
class OpenItem extends AbstractAction
{
    ...
    public string $extJsClass = 'opendxp.plugin.processmanager.executor.action.openItem';
    ...
    {
        return \OpenDxp\Model\Element\Service::getElementById($actionData['type'], $actionData['itemId']);
    }
