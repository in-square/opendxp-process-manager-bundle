...
class JsEvent extends AbstractAction
{
    ...
    public string $extJsClass = 'opendxp.plugin.processmanager.executor.action.jsEvent';
    ...
    {
        $img = '<img src="' . ($actionData['icon'] ?: '/bundles/opendxpadmin/img/flat-color-icons/biohazard.svg') . '" />';
