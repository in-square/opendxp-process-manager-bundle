opendxp.registerNS("opendxp.plugin.processmanager.helper.form");
opendxp.plugin.processmanager.helper.form = Class.create({
    ...
    getTooltip : function (text) {
        return text ? '<img src="/bundles/opendxpadmin/img/flat-color-icons/info.svg" width="17" height="17" class="pm_tooltip_icon" data-qtip="' + text + '"></img>' : '';
    },
    ...
    getPropertySelector : function (fieldName,config) {
        ...
        var url = config.storeUrl || '/admin/insquare-opendxp-process-manager/index/property-list';
