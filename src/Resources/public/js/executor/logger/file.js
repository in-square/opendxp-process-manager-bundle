opendxp.registerNS("opendxp.plugin.processmanager.executor.logger.file");
opendxp.plugin.processmanager.executor.logger.file = Class.create(opendxp.plugin.processmanager.executor.logger.abstractLogger, {
    type: 'file',
    ...
    showLogs: function (monitoringItemId, loggerIndexPositions) {
        ...
        this.stopRefresh();
        var url = '/admin/insquare-opendxp-process-manager/monitoring-item/log-file-logger?id=' + monitoringItemId + '&loggerIndex=' + loggerIndexPositions;
...
var processManagerFileLogger = new opendxp.plugin.processmanager.executor.logger.file();
