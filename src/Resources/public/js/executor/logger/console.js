opendxp.registerNS("opendxp.plugin.processmanager.executor.logger.console");
opendxp.plugin.processmanager.executor.logger.console = Class.create(opendxp.plugin.processmanager.executor.logger.abstractLogger, {
    type: 'console',
