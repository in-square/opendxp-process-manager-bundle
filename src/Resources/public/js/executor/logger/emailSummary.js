opendxp.registerNS("opendxp.plugin.processmanager.executor.logger.emailSummary");
opendxp.plugin.processmanager.executor.logger.emailSummary = Class.create(opendxp.plugin.processmanager.executor.logger.abstractLogger, {
    type: 'emailSummary',
...
var processManagerFileLogger = new opendxp.plugin.processmanager.executor.logger.emailSummary();
