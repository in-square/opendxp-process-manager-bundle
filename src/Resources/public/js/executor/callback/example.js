opendxp.registerNS("opendxp.plugin.processmanager.executor.callback.example");
opendxp.plugin.processmanager.executor.callback.example = Class.create(opendxp.plugin.processmanager.executor.callback.abstractCallback, {
    //a custom name
    name: "example",
    ...
    getFormItems: function () {
       ...
       /* items.push(this.getMultiSelect('classificationIndustry',{
        ...
        var propertySelectorConfig = {
            storeUrl: '/admin/insquare-opendxp-process-manager/index/property-list',
            mandatory: false
            /*,
        ...
        /*
         * The /admin/insquare-opendxp-process-manager/index/property-list call returns a array like this
         {
         "success": true,
         "data": [
         {
