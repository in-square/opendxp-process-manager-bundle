opendxp.registerNS("opendxp.plugin.processmanager.executor.class.abstractExecutor");
opendxp.plugin.processmanager.executor.class.abstractExecutor = Class.create(opendxp.plugin.processmanager.helper.form, {
    id: null,
    mode: 'create',
    rec: null,
    saveUrl: "/admin/insquare-opendxp-process-manager/config/save",
    executorConfig: [],
    ...
    show: function () {
        ...
        this.tabPanel = new Ext.TabPanel({
            ...
            forceLayout: true,
            activeTab: 0,
            id: "opendxp_plugin_pm_panel_config_tabs",
    ...
    getCallbackPredefinedConfig : function () {
        ...
        this.predefinedCallbackStore = new Ext.data.Store({
            autoLoad : true,
            proxy: {
                url: '/admin/insquare-opendxp-process-manager/callback-settings/list',
                type: 'ajax',
                reader: {
                    type: 'json',
                    rootProperty: "data"
            ...
            success: function (response) {
                try {
                    ...
                    if (rdata && rdata.success) {
                        opendxp.helpers.showNotification(t("success"), t("plugin_pm_config_saved_success"), "success");
                        this.closeWindow();
                        ...
                        opendxp.helpers.showNotification(t("error"),  errorMessage , "error");
                    }
                } catch (e) {
                    opendxp.helpers.showNotification(t("error"), t("plugin_pm_config_saved_error"), "error");
                }
            }.bind(this)
        });
    },
