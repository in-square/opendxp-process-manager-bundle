opendxp.registerNS("opendxp.plugin.processmanager.executor.action.jsEvent");
opendxp.plugin.processmanager.executor.action.jsEvent = new Class.create(opendxp.plugin.processmanager.executor.action.abstractAction,{

    getButton : function(){
        this.button = {
            icon: '/bundles/opendxpadmin/img/flat-color-icons/biohazard.svg',
...
var processmanagerPluginJsEvent = new opendxp.plugin.processmanager.executor.action.jsEvent();
