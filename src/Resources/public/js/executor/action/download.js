opendxp.registerNS("opendxp.plugin.processmanager.executor.action.download");
opendxp.plugin.processmanager.executor.action.download = new Class.create(opendxp.plugin.processmanager.executor.action.abstractAction,{
