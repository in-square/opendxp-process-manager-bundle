...
opendxp.registerNS("opendxp.plugin.processmanager.panel.callbackSetting");
opendxp.plugin.processmanager.panel.callbackSetting = Class.create({
    ...
    createGrid: function(response) {
        ...
        var url =  "/admin/insquare-opendxp-process-manager/callback-settings/list?";
        ...
        if(opendxp.globalmanager.get("user").isAllowed("plugin_pm_permission_configure")) {
            ...
            var copy = {
                ...
                items: [{
                    ...
                    icon: "/bundles/opendxpadmin/img/icon/page_white_copy.png",
                    handler: function (grid, rowIndex) {

                        var rec = grid.getStore().getAt(rowIndex);
                        Ext.Ajax.request({
                            url: "/admin/insquare-opendxp-process-manager/callback-settings/copy",
                            params: {
                                id: rec.get("id")
                            },
                                ...
                                buttons: [
                                    {
                                        ...
                                        handler: function () {
                                            ...
                                            Ext.Ajax.request({
                                                url: "/admin/insquare-opendxp-process-manager/callback-settings/delete",
                                                params: {
                                                    id: rec.get("id")
                                                },
