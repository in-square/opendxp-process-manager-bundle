opendxp.registerNS("opendxp.plugin.processmanager.window.detailwindow");
opendxp.plugin.processmanager.window.detailwindow = Class.create({
    getClassName: function (){
        return "opendxp.plugin.processmanager.window.detailwindow";
    },
