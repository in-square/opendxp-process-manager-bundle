...
class Maintenance
{
    ...
    {
        $this->monitoringItem = InSquareOpendxpProcessManagerBundle::getMonitoringItem();
            ...
            if ($recipients !== []) {
                ...
                foreach ($recipients as $emailAdr) {
                    try {
                        ...
                        \OpenDxp\Logger::emergency($message);
                    }
                }
    ...
    protected function clearMonitoringLogs(): void
    {
        ...
        $threshold = InSquareOpendxpProcessManagerBundle::getConfiguration()->getArchiveThresholdLogs();
        if ($threshold !== 0) {
