...
use InSquare\OpendxpProcessManagerBundle\Migrations\Version20210428000000;
...
class Installer extends SettingsStoreAwareInstaller
{
    ...
    protected function createTables(): void
    {
        ...
        $db->executeQuery(
            'CREATE TABLE IF NOT EXISTS `' . InSquareOpendxpProcessManagerBundle::TABLE_NAME_CONFIGURATION . "` (
        ...
        $db->executeQuery(
            'CREATE TABLE IF NOT EXISTS `' . InSquareOpendxpProcessManagerBundle::TABLE_NAME_MONITORING_ITEM . "` (
        ...
        $db->executeQuery(
            'CREATE TABLE IF NOT EXISTS `' . InSquareOpendxpProcessManagerBundle::TABLE_NAME_CALLBACK_SETTING . "` (
            `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
            `creationDate` INT(10) UNSIGNED NOT NULL DEFAULT '0',
            `modificationDate` INT(10) UNSIGNED NOT NULL DEFAULT '0',
            `name` VARCHAR(255) NOT NULL,
    ...
    {
        $tables = [
            InSquareOpendxpProcessManagerBundle::TABLE_NAME_CONFIGURATION,
            InSquareOpendxpProcessManagerBundle::TABLE_NAME_MONITORING_ITEM,
            InSquareOpendxpProcessManagerBundle::TABLE_NAME_CALLBACK_SETTING,
        ];
